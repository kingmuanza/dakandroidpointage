...
public interface IFingerprintService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFingerprintService {
        ...
        static final int TRANSACTION_get_PTAPI_Connection = 1;
        static final int TRANSACTION_register = 2;
        static final int TRANSACTION_setState = 4;
        ...
        private static class Proxy implements IFingerprintService {
            ...
            public int get_PTAPI_Connection(int id_connection) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(id_connection);
            ...
            public int register(int isActivity, String packageName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(isActivity);
            ...
            public void unregister(int id_connection) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setState(int id_connection, int state) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    _result = get_PTAPI_Connection(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    _result = register(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    unregister(data.readInt());
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    setState(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    int get_PTAPI_Connection(int i) throws RemoteException;
